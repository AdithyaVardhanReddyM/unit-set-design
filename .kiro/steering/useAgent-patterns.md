...
id: string;
/** Whether this message is from the user or the assistant _/
role: "user" | "assistant";
/\*\* Array of message parts that make up the complete message _/
parts: MessagePart[];
/** ID of the agent that created this message (for assistant messages) \*/
agentId?: string;
/** When this message was created _/
timestamp: Date;
/\*\* The status of the message, particularly for optimistic user messages _/
...
id: string;
/** The text content, updated incrementally during streaming _/
content: string;
/\*\* Whether the text is still being streamed or is complete _/
...
toolCallId: string;
/** Name of the tool being called _/
toolName: string;
/\*\* Current state of the tool call execution _/
state:
| "input-streaming"
| "input-available"
| "awaiting-approval"
...
input: any;
/** Tool output result, if available _/
output?: any;
/\*\* Error information if the tool call failed _/
error?: any;
}
